  ...
  return (
    <NativeTabs
      ...
      <NativeTabs.Trigger name="sermons">
        <NativeTabs.Trigger.Label>Проповеди</NativeTabs.Trigger.Label>
        <NativeTabs.Trigger.Icon
      ...
      <NativeTabs.Trigger name="testimonies">
        <NativeTabs.Trigger.Label>Свидетельства</NativeTabs.Trigger.Label>
        <NativeTabs.Trigger.Icon
          src={require('@/assets/images/tabIcons/explore.png')}
          renderingMode="template"
        />
      ...
      <NativeTabs.Trigger name="about">
        <NativeTabs.Trigger.Label>О нас</NativeTabs.Trigger.Label>
        <NativeTabs.Trigger.Icon
          src={require('@/assets/images/tabIcons/explore.png')}
          renderingMode="template"
        />
